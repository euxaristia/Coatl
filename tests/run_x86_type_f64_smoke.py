...
def main():
    print('Running ./tests/run_x86_type_f64_smoke.py (generated replacement for ./tests/run_x86_type_f64_smoke.sh)')
    # Generic wrapper
    ...
    # 
    # "$ROOT_DIR/coatl.py" build "$ROOT_DIR/tests/type_f64_smoke.coatl" --toolchain=ir -o "$BIN"
    # 
    # echo "Running binary..."
    # set +e
    # "$BIN"
