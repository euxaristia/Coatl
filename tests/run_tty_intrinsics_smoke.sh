...
IR="$TMP_DIR/tty.ir"
"$ROOT_DIR/coatl" build "$ROOT_DIR/tests/tty_intrinsics_wasi_test.coatl" --toolchain=ir -o "$IR"
...
WAT="$TMP_DIR/tty.wat"
"$ROOT_DIR/coatl" build "$ROOT_DIR/tests/tty_intrinsics_wasi_test.coatl" --toolchain=ir -o "$WAT"
...
ASM="$TMP_DIR/tty.s"
"$ROOT_DIR/coatl" build "$ROOT_DIR/tests/tty_intrinsics_wasi_test.coatl" --toolchain=ir -o "$ASM"
